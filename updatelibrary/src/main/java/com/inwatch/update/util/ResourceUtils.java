    ...
    public static int getResourceIdByName(Context context, String className, String name) {
        ...
        if (context == null) {
            ...
            try {
                ...
                Log.d("inwatch", "ClassNotFoundException: class=" + className + " fieldname=" + name);
            } catch (IllegalArgumentException var8) {
                Log.d("inwatch", "IllegalArgumentException: class=" + className + " fieldname=" + name);
            } catch (SecurityException var9) {
                Log.d("inwatch", "SecurityException: class=" + className + " fieldname=" + name);
            } catch (IllegalAccessException var101) {
                Log.d("inwatch", "IllegalAccessException: class=" + className + " fieldname=" + name);
            } catch (NoSuchFieldException var11) {
                Log.d("inwatch", "NoSuchFieldException: class=" + className + " fieldname=" + name);
            }
